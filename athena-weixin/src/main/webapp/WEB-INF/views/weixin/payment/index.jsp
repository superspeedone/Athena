...
<link rel="stylesheet" href="<%=path%>/resources/weui/lib/weui.css" />
<link rel="stylesheet" href="<%=path %>/resources/weui/css/jquery-weui.css"/>
...
<body>
	...
	<script type="text/javascript" src="<%=path %>/resources/weui/lib/jquery-2.1.4.js"></script>
	<script type='text/javascript' src="<%=path %>/resources/weui/js/jquery-weui.js"></script>
	<!-- layer -->
	...
	function wxpay(){
		...
		$.post("<%=path %>/weixin/payment/transorder",
		    {
		      openId:openId,
		      total_fee:total_fee,
		    },
